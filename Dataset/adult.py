...
meta_path = Path("/home/kuldeep/Fairness_Poject/Data/adult_meta.json")
...
adult_df  = pd.read_csv("/home/kuldeep/Fairness_Poject/Data/adult_processed.csv") 

df = adult_df.copy().reset_index(drop=True)

ALPHAS = [0, 0.1, 0.2, 0.3, 0.4]
SEEDS = [1, 12, 123, 1234, 12345, 54321, 5432, 543, 54, 5]

output_base = Path("/home/kuldeep/Fairness_Poject/Dataset/Adult_Datasets")
