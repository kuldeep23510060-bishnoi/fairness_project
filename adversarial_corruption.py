...
#  Corrupts fraction `alpha` of rows:
#       - numeric_cols: add Gaussian noise ~ N(0, noise_scale * std)
#       - categorical_cols: replace with a different category (random)
#       - protected_col: replace with a different category (random)
#       - label_col: flip 0<->1
