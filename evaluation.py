...
def evaluate(model, df, features, prot_cols, pairs, pair_distances, gamma):
    ...
    parity_gap = 0.0
    if prot_cols in df_eval.columns:
        group0 = df_eval[df_eval[prot_cols] == 0]
        group1 = df_eval[df_eval[prot_cols] == 1]
